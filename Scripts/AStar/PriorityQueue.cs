...
namespace System.Collections.Generic
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        {
            if (initialCapacity < 0) throw new ArgumentOutOfRangeException($"initialCapacity:{initialCapacity} < 0");
        ...
        {
            if(items == null) throw new ArgumentNullException("items null");            
        ...
        {
            if(elements == null) throw new ArgumentNullException("elements null");
        ...
        private void Grow(int minCapacity)
        {
            ...
            if ((uint)newcapacity > 2147483647) newcapacity = 2147483647;
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            {
                if(array == null) throw new ArgumentNullException("array is null", nameof(array));

                if (array.Rank != 1)
                {
                    throw new ArgumentException("multi dim arry not supported", nameof(array));
                }
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(index), index, "IndexMustBeLessOrEqualLength");
                }
